...
const Home = () => {
  ...
  return (
    <div className='' >
      ...
      <div className="flex relative lg:mt-20">
        <img src="https://images.pexels.com/photos/8311891/pexels-photo-8311891.jpeg" alt="" className='w-full h-[40vh] md:h-[50vh] lg:h-[70vh] xl:h-[85vh] object-center object-cover'/>
        <div className='absolute bg-white text-center p-5 rounded-xl top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 lg:w-[20%] w-[40%] hidden md:flex flex-col'>
          <h1 className='lg:text-4xl md:text-3xl mb-5 text-left'>Ready to declutter you closet?</h1>
      ...
      <div className='flex flex-col gap-2 py-5 items-center'>
        ...
        <div className='flex gap-5 w-4/5 flex-wrap'>
          ...
          <Button className='bg-white border border-black'>American Eagle</Button>
        </div>
      </div>
